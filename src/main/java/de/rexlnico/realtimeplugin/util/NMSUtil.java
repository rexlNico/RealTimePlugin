...
public class NMSUtil {
    ...
    public static void sendLightning(Player player, Location l) {
        ...
        try {
            ...
            Object obj = Objects.requireNonNull(getNMSClass("PacketPlayOutSpawnEntityWeather")).getConstructor(getNMSClass("Entity")).newInstance(lighobj);
    ...
    public static void sendGameState(Player player, int type, float state) throws InstantiationException, NoSuchFieldException {
        try {
            ...
            final Object packet = Objects.requireNonNull(getNMSClass("PacketPlayOutGameStateChange")).getConstructor(Integer.TYPE, Float.TYPE).newInstance(type, state);
